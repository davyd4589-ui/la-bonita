...
const slides = [
  {
    ...
    headline: "Bem-vinda ao La Bonita",
    subheading: "Seu Salão de Beleza em Goiânia",
    description: "Ambiente sofisticado e acolhedor com profissionais especializados para cuidar da sua beleza.",
